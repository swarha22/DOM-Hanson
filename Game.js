...
let charanValue = document.getElementById("userNmber");
...
function check() {
  if (count != 0) {
    if (randomNumber > charanValue.value) {
      message[0].innerHTML = "Your Guess is Low";
      console.log("Your Guess is Low");
      count--;
      counts[0].innerHTML = `${count}`;
    } else if (randomNumber < charanValue.value) {
      message[0].innerHTML = "Your Guess is High";
      ...
      message[0].innerHTML = "🥳Your Guess is Right You Won🥳";
